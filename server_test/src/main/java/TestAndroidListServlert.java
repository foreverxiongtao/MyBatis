 ...
 */
public class TestAndroidListServlert extends HttpServlet {
...
//        queryUserAPI(resp);
    ...
    private void queryUser(HttpServletResponse response) {
        ...
        try {
            inputStream = TestAndroidListServlert.class.getClassLoader().getResourceAsStream(resource);
            SqlSessionFactory sqlSessionFactory = new SqlSessionFactoryBuilder().build(inputStream);
            SqlSession session = sqlSessionFactory.openSession();
            try {
                List<UserDataEntity> user = session.selectList("com.mybatis.test.AndroidMapper.selectUser");
